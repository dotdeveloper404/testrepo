				...
				<div class="card-body">
					<div class="form-group row">
						...
						<div class="col-lg-6">
							...
							<input required type="text" name="phone" class="form-control" placeholder="Enter contact number"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							...
							<div class="input-group">
								<input required type="text" name="post_code" class="form-control" placeholder="Enter your postcode"/>
