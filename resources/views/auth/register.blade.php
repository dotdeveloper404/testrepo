    ...
    <div class="login login-5 login-signin-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
            ...
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                <!--begin::Login Header-->
                <div class="d-flex flex-center mb-10" style="font-size: 60px;font-weight: 700;font-family: sans-serif;">
                        Stealth
                </div>
                <!--end::Login Header-->
                ...
                <div class="login-signin">
                    <div class="mb-20">
                        <h3 class="opacity-40 font-weight-normal">Register Area</h3>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                   type="text" required placeholder="Name" name="name" autocomplete="off"/>
                            ...
                            <div class="form-group">
                                <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                       type="email" required placeholder="Email" name="email" autocomplete="off"/>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                           type="password" placeholder="Password"  required autocomplete="new-password" name="password_confirmation"/>
                            ...
                            <div class="form-group text-center mt-10">
                                ...
                                <input type="submit" value="{{ __('Register') }}" name="submit" class="btn btn-pill btn-primary opacity-90 px-15 py-3" />
                    ...
                    <form class="form text-center" id="kt_login_signup_form">
                        ...
                        <div class="form-group">
                            <button id="kt_login_signup_submit"
                                    class="btn btn-pill btn-primary opacity-90 px-15 py-3 m-2">Sign Up
                            </button>
