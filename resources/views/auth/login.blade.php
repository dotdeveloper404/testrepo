        ...
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
            ...
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                ...
                <div class="login-signin">
                    <div class="mb-20">
                        <h3 class="opacity-40 font-weight-normal">Customer Area</h3>
                    </div>

                    <login></login>

                <form  method="post" action="{{ route('login') }}"   class="" id="">
                    @csrf
...
{{--                                Password ?</a>--}}
                        ...
                        <div class="form-group text-center mt-10">
                            ...
                            <input type="submit" value="Sign In" name="submit" class="btn btn-pill btn-primary opacity-90 px-15 py-3" />
